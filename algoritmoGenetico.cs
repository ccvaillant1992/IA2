namespace iac
{
    ...
    public class AlgoritmoGenetico
    {
        ...
        private int tamañoPoblacion= 100; //Tamaño de la Poblacion
        ...
        private Individuo[] crossover(Individuo padre1, Individuo padre2)
        {
             ...
             posicion1=r.nextInt(Matrices.getlocations);
             do{
                 posicion2=r.nextInt(Matrices.getlocations);
             ...
             Set<Integer> Individuohijo0 = new HashSet<>();
             Set<Integer> Individuohijo1 = new HashSet<>();
             ...
             for(int i=0; i<distance.Length;i++)
             {
                 ...
                 {
                     int iterador=0;
                     while (Individuohijo0.contiene(padre1.obtenerSolucion()[iterador])){
                         iterador++;
                     }
                     ...
                     iterador=0;
                     while (Individuohijo1.contiene(padre0.obtenerSolucion()[iterador]))
                     {
                         iterador++;
                     }
